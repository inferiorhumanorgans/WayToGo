...
public class TabsActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener {
    ...
    private void updateTabSummary(final String aNumber) {
        ...
        final int summaryId = theResources.getIdentifier("string/pref_tab" + aNumber + "_summary", null, "com.zippy.WayToGo");
        final int defaultId = theResources.getIdentifier("string/pref_tab" + aNumber + "_default", null, "com.zippy.WayToGo");
