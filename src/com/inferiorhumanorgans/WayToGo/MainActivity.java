...
import com.inferiorhumanorgans.WayToGo.Bookmarks.BookmarksDataHelper;
...
public class MainActivity extends TabActivity implements CopyDBListener, OnSharedPreferenceChangeListener {
    ...
    protected void onPause() {
        ...
        stopService(new Intent(this, com.inferiorhumanorgans.WayToGo.GPS.TheGPSService.class));
    }
    ...
    public void onResume() {
        ...
        mTabHost.getTabContentView().requestFocus();
        startService(new Intent(this, com.inferiorhumanorgans.WayToGo.GPS.TheGPSService.class));
    ...
    private void addBookmarkTab() {
        ...
        intent = new Intent().setClass(this, com.inferiorhumanorgans.WayToGo.Bookmarks.BookmarkActivity.class);
    ...
    private void addMapTab() {
        ...
        Intent intent;
        String tabName = "Map";
        intent = new Intent().setClass(this, com.inferiorhumanorgans.WayToGo.MapView.AllStopsActivity.class);
        spec = mTabHost.newTabSpec(tabName);
        spec.setContent(intent);
