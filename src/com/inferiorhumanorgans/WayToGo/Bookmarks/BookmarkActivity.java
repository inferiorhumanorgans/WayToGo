...
import com.inferiorhumanorgans.WayToGo.Comparator.BookmarkByDistanceComparator;
    ...
    public boolean onContextItemSelected(final MenuItem anItem) {
        ...
        switch (anItem.getItemId()) {
            case R.id.context_view_stop_on_map:
                Intent myIntent = new Intent(getParent(), com.inferiorhumanorgans.WayToGo.MapView.OneStopActivity.class);
