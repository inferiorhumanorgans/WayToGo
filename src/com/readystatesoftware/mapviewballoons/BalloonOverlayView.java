...
public class BalloonOverlayView<Item extends OverlayItem> extends FrameLayout {
    ...
    private static final String LOG_NAME = BalloonOverlayView.class.getSimpleName();
    ...
    public BalloonOverlayView(Context context, int balloonBottomOffset) {
        ...
        View v = inflater.inflate(R.layout.map_balloon_overlay, layout);
    ...
    public void setData(Item item) {
        ...
        layout.setVisibility(VISIBLE);
        StopOverlayItem theStopItem = null;
        if (item instanceof StopOverlayItem) {
            theStopItem = (StopOverlayItem) item;
        } else {
            Log.d(LOG_NAME, "Did not get a spannable overlayitem " + item);
        }
